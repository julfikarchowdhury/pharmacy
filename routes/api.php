...
Route::get('/medicine-details-for-pharmacy/{medicine}', [MedicineController::class, 'medicineDetailsForPharmacy']);
...
Route::middleware(['auth:sanctum', 'role:user'])->group(function () {
    ...
    Route::post('user-orders', [OrderController::class, 'userOrders']);
});
